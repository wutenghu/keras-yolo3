...
def create_model(input_shape,
    ...
    """
    create the training model, set the trainable part of the model
    :param input_shape:
    :param anchors:
    :param num_classes:
    ...
    if load_pretrained:
        ...
        if freeze_body in [1, 2]:
            # Freeze the model  body or freeze all but 3 output layers.
...
def create_tiny_model(input_shape, anchors, num_classes, load_pretrained=True, freeze_body=2,
    ...
    """
    create the training model, for the Tiny YOLOv3
    :param input_shape:
    :param anchors:
    :param num_classes:
    :param load_pretrained:
